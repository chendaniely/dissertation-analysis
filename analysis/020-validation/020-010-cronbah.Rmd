...
I only added Questions with a loading >= 0.60

```{r}
ml1 <- wide_survey_likert %>%
  dplyr::select(Q3.4, Q3.3, Q3.5, Q7.2_2, Q3.1, Q7.2_5, Q5.2, Q7.2_4) %>%
  data.matrix() %>%
  psych::alpha()
...
```{r}
ml2 <- wide_survey_likert %>%
  dplyr::select(Q6.2, Q6.2, Q6.3) %>%
  data.matrix() %>%
  psych::alpha()
