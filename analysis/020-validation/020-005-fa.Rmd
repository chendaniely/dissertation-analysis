...
corrplot(data_corr, method="color", col=col(200),  
         type="full", order="hclust", 
         addCoef.col = "black", # Add coefficient of correlation
         tl.col="black", tl.srt=45, #Text label color and rotation
         # Combine with significance
         p.mat = sim_data_corr_p, sig.level = 0.05, insig = "blank", 
...
```{r}
f3_good <- fa(scaled_good, 3, rotate="varimax", scores="tenBerge", fm = "minchi")
print(f3_good)
