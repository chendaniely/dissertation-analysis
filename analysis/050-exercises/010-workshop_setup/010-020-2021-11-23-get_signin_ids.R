...
qualify <- signin %>%
  filter(stringr::str_starts(Q1.3, "Yes"),
         ...
         RecordedDate >= "2021-11-23",
         RecordedDate <= "2021-11-24"
         )
...
qualify_ids %>%
  readr::write_csv("~/../Desktop/ds4biomed_exercises_notes/2021-11-23.csv")


unqualify_ids

unqualify_ids %>%
  readr::write_csv("~/../Desktop/ds4biomed_exercises_notes/2021-11-23-unqualify.csv")
